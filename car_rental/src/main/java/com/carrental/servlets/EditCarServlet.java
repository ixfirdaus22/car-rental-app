...
public class EditCarServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        // 🔐 Validation
        if (ValidationUtil.isEmpty(carIdStr) ||
            ...
            response.sendRedirect("host/edit-car.jsp?error=invalid");
            return;
        }
        ...
        if (existingCar == null || existingCar.getHostId() != user.getUserId()) {
            response.sendRedirect("host/dashboard.jsp?error=unauthorized");
            return;
        }
        ...
        if (success) {
            ...
            response.sendRedirect("host/edit-car.jsp?error=db");
        }
    }
}
